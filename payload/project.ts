...
const project: IProject.Payload = {
  ...
  list: [
    ...
    },
    {
      ...
      startedAt: '2020-07',
      where: 'GSA Infoteam 학생회 산하 특별자치회 공동작업, Back-end 작업',
      descriptions: [
    ...
    },
    {
      ...
      startedAt: '2021-01',
      where: 'GSA Infoteam 학생회 산하 특별자치회 내 구성원 1인과의 프로젝트, 주로 Back-end 작업',
      descriptions: [
        ...
        { content: '자치회 또는 동아리별, 연도별 신입부원 모집을 하나의 프로젝트로 간주하고 프로젝트들을 추가, 삭제할 수 있도록 제작' },
